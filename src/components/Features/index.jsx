...
export default function Features() {
  ...
  return (
    <div className="container mx-auto max-w-[1344px]" id="feature">
      <div className="flex flex-col gap-10 px-5 py-16 sm:pb-28 sm:px-10 md:pb-36">
        ...
        >
          ...
          >
            Temukan fitur-fitur unggulan kami di BarKit, pilihan terbaik untuk
            kebutuhan sewa barang Anda. Berikut adalah beberapa fitur yang
            menjadikan kami pilihan yang tepat
          </Paragraph>
        </motion.div>
